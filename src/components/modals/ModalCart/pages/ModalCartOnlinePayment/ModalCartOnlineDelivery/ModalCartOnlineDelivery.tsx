import classes from './ModalCartOnlineDelivery.module.scss'
...
interface ModalCartOnlineDeliveryProps {
  selectDelivery: (delivery: string) => void
}

function ModalCartOnlineDelivery({
  selectDelivery,
}: ModalCartOnlineDeliveryProps) {
          ...
          {deliveryList.map(({ name, id, slug, description }, index) => (
            ...
            >
              ...
              <HandySvg
                ...
                className={clsx(
                  classes.Icon,
                  slug === deliveryType && classes.ActiveIcon,
                )}
              />
            </li>
          ))}
...
export default ModalCartOnlineDelivery
